...
El contenido del documento anterior lo debemos almacenar en una archivo llamado `docker-compose.yaml` o `compose.yaml` yo lo he almacenado en la carpeta *npm* dentro de *docker*
y ejecutamos el comando para levantarlo, 
<TerminalWindow title="jrodriiguezg@blogvm:~/docker/npm">
  ```text
...
<img src="https://assets.jrodriiguezg.link/bloque_serviciosII/NPM_1.png" alt="phns1" width="700" style="max-width: 100%; height: auto; display: block; margin: 1.5rem auto; border-radius: 12px; box-shadow: var(--box-shadow);" />

Aqui solamente debemos rellenar con nuestros datos y pulsar en *Save*

<img src="https://assets.jrodriiguezg.link/bloque_serviciosII/npm_2.png" alt="phns1" width="700" style="max-width: 100%; height: auto; display: block; margin: 1.5rem auto; border-radius: 12px; box-shadow: var(--box-shadow);" />
...
<img src="https://assets.jrodriiguezg.link/bloque_serviciosII/npm_3.png" alt="phns1" width="700" style="max-width: 100%; height: auto; display: block; margin: 1.5rem auto; border-radius: 12px; box-shadow: var(--box-shadow);" />
...
<img src="https://assets.jrodriiguezg.link/bloque_serviciosII/NPM_4.png" alt="phns1" width="700" style="max-width: 100%; height: auto; display: block; margin: 1.5rem auto; border-radius: 12px; box-shadow: var(--box-shadow);" />
...
<img src="https://assets.jrodriiguezg.link/bloque_serviciosII/NPM_5.png" alt="phns1" width="700" style="max-width: 100%; height: auto; display: block; margin: 1.5rem auto; border-radius: 12px; box-shadow: var(--box-shadow);" />
...
<TerminalWindow title="jrodriiguezg@blogvm:~/docker/pihole">
  ```text
...
<img src="https://assets.jrodriiguezg.link/bloque_serviciosII/ph_1.png" alt="phns1-dns" width="700" style="max-width: 100%; height: auto; display: block; margin: 1.5rem auto; border-radius: 12px; box-shadow: var(--box-shadow);" />
> Si no poneis contraseña y se os olvida seguramente sea esta: *tu_contraseña_segura*

Finalmente accedemos al panel de pihole, 
<img src="https://assets.jrodriiguezg.link/bloque_serviciosII/ph_2.png" alt="phns1-dns" width="700" style="max-width: 100%; height: auto; display: block; margin: 1.5rem auto; border-radius: 12px; box-shadow: var(--box-shadow);" />
