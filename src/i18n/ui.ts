...
export const ui = {
	es: {
		...
		'comments.giscusPendingTitle': 'Configuración de comentarios pendiente',
		'comments.giscusPendingDesc': 'Para activar los comentarios de Giscus, por favor habilita GitHub Discussions en tu repositorio e introduce el Category ID en src/consts.ts.',
		...
		'comments.errorLoad': 'Error al cargar los comentarios.',
		'comments.connErrorLoad': 'Error de conexión al cargar comentarios.',
		...
		'search.prompt': 'Escribe para empezar a buscar...',
	...
	en: {
		...
		'comments.giscusPendingTitle': 'Giscus Comments setup pending',
		'comments.giscusPendingDesc': 'To enable Giscus comments, please enable GitHub Discussions in your repository and set the Category ID in src/consts.ts.',
		...
		'comments.errorLoad': 'Error loading comments.',
		'comments.connErrorLoad': 'Connection error loading comments.',
		...
		'search.prompt': 'Type to begin searching...',
